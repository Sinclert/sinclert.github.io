...
When considering how to evolve a SQL database schema, there are a range of common operations
...
#### Problem description
Modern databases use table locks to protect the integrity of the data they holds.
